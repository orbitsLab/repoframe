...
export const metadata: Metadata = {
  title: 'About',
  description: 'Why Repo Frame is local-first and open source.',
};

export default function AboutPage() {
  return (
    <main className="mx-auto max-w-4xl px-6 py-16 sm:py-24">
      <p className="site-eyebrow text-muted-foreground">About Repo Frame</p>
      ...
      <div className="mt-12 grid gap-px overflow-hidden rounded-lg border bg-border md:grid-cols-2">
        <section className="bg-background p-7">
          ...
          <p className="mt-3 leading-7 text-muted-foreground">
            Repo Frame turns public GitHub repository data into customizable
        ...
        <section className="bg-background p-7">
          ...
          <p className="mt-3 leading-7 text-muted-foreground">
            Repo Frame ships without analytics in v1. There is no quiet tracking
